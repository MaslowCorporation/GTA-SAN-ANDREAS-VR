...
Make sure you start SteamVR from within Oculus Link, rather than from your computer, 
because sometimes, if you start SteamVR from your computer, the headset doesn't go to SteamVR,
whereas if you do start SteamVR from within Oculus Link, then the headset switches to SteamVR without issue ;-)
